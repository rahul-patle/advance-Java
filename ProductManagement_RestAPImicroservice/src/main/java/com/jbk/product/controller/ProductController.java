...
public class ProductController {
	...
	public ResponseEntity<Product_Supplier> getProductWithSupplierByProductId(@PathVariable String productId) {
		Product_Supplier productWithSupplierProductId = service.getProductWithSupplierProductId(productId);

		if (productWithSupplierProductId != null) {

			return new ResponseEntity<Product_Supplier>(productWithSupplierProductId, HttpStatus.OK);
		} else {
			return new ResponseEntity<Product_Supplier>(productWithSupplierProductId, HttpStatus.INTERNAL_SERVER_ERROR);
		}
